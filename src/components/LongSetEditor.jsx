...
import './LongSetEditor.css'

function LongSetEditor({ onBack, editingSet, onSave }) {
  ...
  const handleSaveSet = async (saveAsDraft = false) => {
    ...
    try {
      ...
      if (editingSet) {
        ...
        alert(saveAsDraft ? '✅ Set updated as draft!' : '✅ Set finalised and updated successfully!')
      } else {
        // Create new set
        setData.id = Date.now().toString()
        setData.createdAt = new Date().toISOString()
        await setsAPI.create(setData)
        alert(saveAsDraft ? '✅ Set saved as draft!' : '✅ Set finalised and saved successfully!')
      }
  ...
  return (
    <div className="long-set-editor">
      <div className="editor-header">
        ...
        <h2>{editingSet ? 'Edit Long Set' : 'Long Set Editor'}</h2>
      </div>
